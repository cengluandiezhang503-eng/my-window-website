    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <nav className="bg-white border-b px-8 py-4 flex justify-between items-center">
        ...
        <ul className="flex gap-8 text-gray-800 font-medium text-sm">
          ...
          >
            <button className={'font-medium ' + (menuOpen === 'windows' ? 'border-b-2 border-red-700 text-red-700' : 'hover:text-red-700')}>
              窗户与门
            </button>
          ...
          <li
            className="relative py-2"
            onMouseEnter={function() { setMenuOpen('inspiration'); setSearchOpen(false); }}
            onMouseLeave={function() { setMenuOpen(null); }}
          >
            <button className={'font-medium ' + (menuOpen === 'inspiration' ? 'border-b-2 border-red-700 text-red-700' : 'hover:text-red-700')}>
              灵感
            </button>
          ...
          <li
            className="relative py-2"
            onMouseEnter={function() { setMenuOpen('support'); setSearchOpen(false); }}
            onMouseLeave={function() { setMenuOpen(null); }}
          >
            <button className={'font-medium ' + (menuOpen === 'support' ? 'border-b-2 border-red-700 text-red-700' : 'hover:text-red-700')}>
              服务支持
            </button>
          ...
          <li
            className="relative py-2"
            onMouseEnter={function() { setMenuOpen('docs'); setSearchOpen(false); }}
            onMouseLeave={function() { setMenuOpen(null); }}
          >
            <button className={'font-medium ' + (menuOpen === 'docs' ? 'border-b-2 border-red-700 text-red-700' : 'hover:text-red-700')}>
              技术文档
            </button>
          ...
          <li
            className="relative py-2"
            onMouseEnter={function() { setMenuOpen('pros'); setSearchOpen(false); }}
            onMouseLeave={function() { setMenuOpen(null); }}
          >
            <button className={'font-medium ' + (menuOpen === 'pros' ? 'border-b-2 border-red-700 text-red-700' : 'hover:text-red-700')}>
              专业人士
            </button>
